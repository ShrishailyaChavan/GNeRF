...
if __name__ == '__main__':
    ...
    gt_qua = rotation_matrix_to_quaternion(R_pred.contiguous())  

    out_lines = torch.cat((t_pred, gt_qua), -1) 
    ...
    gt_qua = rotation_matrix_to_quaternion(gt_R.contiguous()) 

    out_lines = torch.cat((gt_t, gt_qua), -1) 
